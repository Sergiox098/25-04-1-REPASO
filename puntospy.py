...
# print(f"También se puede usar el f-print para concatenar variables")
...
#     suma = suma + i**2
# print(f"La suma de los {i} primeros números naturales es igual a: {suma}")
...
#     suma = suma + i
# print(f"La suma de los siguientes 100 numeros de {num} sin incluir {num} es igual a: {suma}")
...
# print(f"Los números impares menores que {E22_num} son:")
...
#     else:
#         menor = E26_num3
# elif (E26_num3 > E26_num1) and (E26_num3 > E26_num2):
#     mayor = E26_num3
#     if E26_num1 < E26_num2:
#         menor = E26_num1
#     else:
#         menor = E26_num2    
...
# cont=2
# primo=[]
# limiteprimo = int(input("Ingrese el rango máximo para la búsqueda de números primos: "))

# while cont <= limiteprimo:
